...
class getSecurity_AccessMapService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/secretary'), [0 => 'ROLE_SECRETARY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/patient'), [0 => 'ROLE_PATIENT'], NULL);
