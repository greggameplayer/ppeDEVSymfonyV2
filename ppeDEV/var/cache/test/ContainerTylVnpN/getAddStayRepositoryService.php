 ...
 */
class getAddStayRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\AddStayRepository' shared autowired service.
     *
     * @return \App\Repository\AddStayRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AddStayRepository.php';

        return $container->privates['App\\Repository\\AddStayRepository'] = new \App\Repository\AddStayRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
