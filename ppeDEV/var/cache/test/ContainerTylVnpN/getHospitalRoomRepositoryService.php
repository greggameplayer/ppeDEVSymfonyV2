 ...
 */
class getHospitalRoomRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\HospitalRoomRepository' shared autowired service.
     *
     * @return \App\Repository\HospitalRoomRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HospitalRoomRepository.php';

        return $container->privates['App\\Repository\\HospitalRoomRepository'] = new \App\Repository\HospitalRoomRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
