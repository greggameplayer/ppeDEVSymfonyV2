 ...
 */
class getBedRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\BedRepository' shared autowired service.
     *
     * @return \App\Repository\BedRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BedRepository.php';

        return $container->privates['App\\Repository\\BedRepository'] = new \App\Repository\BedRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
