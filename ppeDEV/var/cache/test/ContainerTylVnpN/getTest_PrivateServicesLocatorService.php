...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\DataFixtures\\AddStayFixtures' => ['privates', 'App\\DataFixtures\\AddStayFixtures', 'getAddStayFixturesService', true],
            'App\\DataFixtures\\BedFixtures' => ['privates', 'App\\DataFixtures\\BedFixtures', 'getBedFixturesService', true],
            'App\\DataFixtures\\HospitalRoomFixtures' => ['privates', 'App\\DataFixtures\\HospitalRoomFixtures', 'getHospitalRoomFixturesService', true],
            'App\\DataFixtures\\ManageFixtures' => ['privates', 'App\\DataFixtures\\ManageFixtures', 'getManageFixturesService', true],
            'App\\DataFixtures\\PatientFixtures' => ['privates', 'App\\DataFixtures\\PatientFixtures', 'getPatientFixturesService', true],
            'App\\DataFixtures\\ServiceFixtures' => ['privates', 'App\\DataFixtures\\ServiceFixtures', 'getServiceFixturesService', true],
            'App\\DataFixtures\\StaffFixtures' => ['privates', 'App\\DataFixtures\\StaffFixtures', 'getStaffFixturesService', true],
            'App\\DataFixtures\\StayFixtures' => ['privates', 'App\\DataFixtures\\StayFixtures', 'getStayFixturesService', true],
            'App\\Form\\HospitalRoomType' => ['privates', 'App\\Form\\HospitalRoomType', 'getHospitalRoomTypeService', true],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.20QaBDz', 'get_ServiceLocator_20QaBDzService', true],
            ...
            'App\\DataFixtures\\AddStayFixtures' => '?',
            'App\\DataFixtures\\BedFixtures' => '?',
            'App\\DataFixtures\\HospitalRoomFixtures' => '?',
            'App\\DataFixtures\\ManageFixtures' => '?',
            'App\\DataFixtures\\PatientFixtures' => '?',
            'App\\DataFixtures\\ServiceFixtures' => '?',
            'App\\DataFixtures\\StaffFixtures' => '?',
            'App\\DataFixtures\\StayFixtures' => '?',
            'App\\Form\\HospitalRoomType' => '?',
