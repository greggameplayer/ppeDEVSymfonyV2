 ...
 */
class getUpdateStatusRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\UpdateStatusRepository' shared autowired service.
     *
     * @return \App\Repository\UpdateStatusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UpdateStatusRepository.php';

        return $container->privates['App\\Repository\\UpdateStatusRepository'] = new \App\Repository\UpdateStatusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
