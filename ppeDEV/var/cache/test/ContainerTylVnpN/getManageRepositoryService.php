 ...
 */
class getManageRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ManageRepository' shared autowired service.
     *
     * @return \App\Repository\ManageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ManageRepository.php';

        return $container->privates['App\\Repository\\ManageRepository'] = new \App\Repository\ManageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
