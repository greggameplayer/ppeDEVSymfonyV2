...
delete-index: ## Delete a given index (paremters: index=app_2021-01-05-075600")
...
check: ## Check if the database Docker container is healty and ready
	test '"healthy"' = `$(DOCKER) inspect --format "{{json .State.Health.Status }}" sb-db`
...
# Snippet L162+4 => templates/blog/posts/_123.html.twig
...
# Snippet L187+4 => templates/snippet/code/_128.html.twig
...
# Snippet L222+17 => templates/blog/posts/_126.html.twig