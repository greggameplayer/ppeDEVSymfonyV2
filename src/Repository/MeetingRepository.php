    ...
    */
    ...
    public function findByBetweenDatesUnavailableEvents($start, $end)
    {
        return $this->createQueryBuilder('q')
            ...
            ->setParameter('statOne', $this->getEntityManager()->getRepository(Status::class)->findOneBy(['id' => 4]))
            ->setParameter('statTwo', $this->getEntityManager()->getRepository(Status::class)->findOneBy(['id' => 6]))
